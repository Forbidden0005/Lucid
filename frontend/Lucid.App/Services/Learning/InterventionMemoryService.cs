...
/// behavioral profile.
///
/// All storage is local-only (%LOCALAPPDATA%\Lucid\intervention_memory.json).
...
/// %LOCALAPPDATA%\Lucid\intervention_memory.json on every write.
///
...
public sealed class InterventionMemoryService : IInterventionMemoryService
{
    ...
    private static readonly string s_filePath = Path.Combine(
        ...
        "Lucid", "intervention_memory.json");
