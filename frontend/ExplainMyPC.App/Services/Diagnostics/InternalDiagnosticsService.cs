...
public sealed class InternalDiagnosticsService : IInternalDiagnosticsService, IDisposable
{
    ...
    public void OnGovernanceModeChanged(
        ExplainMyPC.Services.Governance.RuntimeMode previous,
        ExplainMyPC.Services.Governance.RuntimeMode next,
        ExplainMyPC.Services.Governance.ThrottlingReason reasons)
    {
        try
        {
            ...
            _events.Append(
                ...
                next == ExplainMyPC.Services.Governance.RuntimeMode.Normal
