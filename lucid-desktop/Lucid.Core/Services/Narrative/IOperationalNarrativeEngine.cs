...
///   Call <see cref="Stop"/> from the composition root shutdown path.
/// </summary>
public interface IOperationalNarrativeEngine
{
    ...
    /// <summary>Subscribes to the intelligence engine. Call once from the composition root.</summary>
    void Start();

    /// <summary>Unsubscribes from the intelligence engine. Call from the composition root shutdown path.</summary>
    void Stop();
}
