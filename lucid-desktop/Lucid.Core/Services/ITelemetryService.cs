...
///
/// Lifetime:
///   The service is started once from the composition root and runs for
...
public interface ITelemetryService
{
    ...
    /// <summary>Starts the background polling loop. Called once from the composition root.</summary>
    void Start();
