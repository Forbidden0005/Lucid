...
///   Startup settling  — within 5 minutes of Lucid launch (proxy for
...
public sealed record SessionContext
{
    ...
    /// <summary>
    /// Time when Lucid was launched — used as a proxy for the moment
    ...
    /// detected since Lucid started (gap-detection heuristic).
    /// </summary>
    ...
    /// <summary>Time elapsed since Lucid was launched.</summary>
    ...
    /// <summary>
    /// True within 5 minutes of Lucid launch (post-login proxy).
